...
import { Button, Flex, HStack, Text, Textarea, FormLabel, Input } from '@chakra-ui/react';
...
export default function Packetflow() {
    ...
    useEffect(() => {
      ...
      return (
        <>
          <Text p='10px' fontSize={15} color="white">👉 Instructions: Enter Any Combination of Source/Destination IP or Source/Destination Port, once Start Debug is complete click on Run FortiGPT 👈</Text>
          <Flex justifyContent="center" alignItems="center" p='10px'>
            ...
            />
            <FormLabel pl='10px' color={'white'}>Destination IP:</FormLabel>
            <Input
              width='150px'
              id='username'
          ...
          <Flex justifyContent="center" alignItems="center" p='10px'>
            ...
            <Input
              ...
              onChange={formik.handleChange}
            />
            <FormLabel pl='10px' color={'white'}>Destination Port:</FormLabel>
            <Input
              width='150px'
              id='username'
